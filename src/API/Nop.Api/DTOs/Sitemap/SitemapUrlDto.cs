...
/// </summary>
[JsonObject(Title = "SitemapUrl")]
public partial record SitemapUrlDto : BaseNopDto
{
    #region Ctor
    ...
    public SitemapUrlDto(string location, IList<string> alternateLocations, UpdateFrequency frequency, DateTime updatedOn)
    {
        Location = location;
    ...
    public SitemapUrlDto(string location, SitemapUrlDto sitemapUrl)
    {
        Location = location;
    ...
    [JsonProperty("alternate_locations")]
