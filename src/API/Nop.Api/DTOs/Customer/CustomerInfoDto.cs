...
[JsonObject(Title = "CustomerInfo")]
public partial record CustomerInfoDto : BaseNopDto
{
    ...
    [JsonProperty("email_to_revalidate")]
    ...
    [JsonProperty("allow_users_to_change_usernames")]
    ...
    [JsonProperty("signature_enabled")]
    ...
    [JsonProperty("vat_number_status_note")]
    ...
    [JsonProperty("associated_external_auth_records")]
    public IList<AssociatedExternalAuthModel> AssociatedExternalAuthRecords { get; set; }

    [JsonProperty("number_of_external_authentication_providers")]
    public int NumberOfExternalAuthenticationProviders { get; set; }

    [JsonProperty("allow_customers_to_remove_associations")]
    ...
    public partial record AssociatedExternalAuthModel : BaseNopEntityDto
    {
