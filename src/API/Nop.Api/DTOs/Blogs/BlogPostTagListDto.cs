...
[JsonObject(Title = "BlogPostTagList")]
public partial record BlogPostTagListDto : BaseNopDto
{
    public BlogPostTagListDto()
    {
        Tags = new List<BlogPostTagDto>();
    }

    public int GetFontSize(BlogPostTagDto blogPostTag)
    {
