...
public partial class DownloadController : BasePublicController
{
    ...
    [HttpGet]
    [Route("Sample/{productId}", Name = "Sample")]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
    public virtual async Task<IActionResult> Sample([FromRoute] int productId)
    {
    ...
    [CheckLanguageSeoCode(ignore: true)]
    [HttpGet]
    [Route("GetDownload", Name = "GetDownload")]
    [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
    public virtual async Task<IActionResult> GetDownload([FromQuery] Guid orderItemId, [FromQuery] bool agree = false)
    {
    ...
    [CheckLanguageSeoCode(ignore: true)]
    [HttpGet]
    [Route("GetLicense", Name = "GetLicense")]
    [ProducesResponseType(typeof(ProblemDetails), (int)HttpStatusCode.BadRequest)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
    public virtual async Task<IActionResult> GetLicense([FromQuery] Guid orderItemId)
    {
        var orderItem = await _orderService.GetOrderItemByGuidAsync(orderItemId);
        if (orderItem == null)
            return InvokeHttp404();
