...
public partial class BackInStockSubscriptionController : BasePublicController
{
    ...
    [HttpGet]
    [Route("SubscribePopup/{productId}", Name = "SubscribePopup")]
    [ProducesResponseType(typeof(BackInStockSubscribeDto), (int)HttpStatusCode.OK)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
    public virtual async Task<IActionResult> SubscribePopup([FromRoute] int productId)
    {
        ...
        var model = new BackInStockSubscribeDto
        {
        ...
        if (
            ...
            product.AllowBackInStockSubscriptions && product.StockQuantity <= 0)
        {
            //out of stock
    ...
    [HttpPost]
    [Route("SubscribePopupPOST/{productId}", Name = "SubscribePopupPOST")]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.OK)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.NotFound)]
    public virtual async Task<IActionResult> SubscribePopupPOST([FromRoute] int productId)
    {
        var product = await _productService.GetProductByIdAsync(productId);
        if (product == null || product.Deleted)
            throw new ArgumentException("No product found with the specified id");
    ...
    [HttpGet]
    [Route("CustomerSubscriptions", Name = "CustomerSubscriptions")]
    [ProducesResponseType(typeof(CustomerBackInStockSubscriptionsDto), (int)HttpStatusCode.OK)]
    ...
    public virtual async Task<IActionResult> CustomerSubscriptions([FromQuery] int? pageNumber)
    {
        ...
        var model = new CustomerBackInStockSubscriptionsDto();
        ...
        foreach (var subscription in list)
        {
            ...
            if (product != null)
            {
                var subscriptionModel = new BackInStockSubscriptionDto
                {
                    Id = subscription.Id,
                    ProductId = product.Id,
                    ProductName = await _localizationService.GetLocalizedAsync(product, x => x.Name),
    ...
    [HttpPost]
    [Route("CustomerSubscriptionsPOST", Name = "CustomerSubscriptionsPOST")]
    [ProducesResponseType(typeof(CustomerBackInStockSubscriptionsDto), (int)HttpStatusCode.OK)]
    [ProducesResponseType(typeof(string), (int)HttpStatusCode.Unauthorized)]
