...
/// </summary>
public partial interface ISitemapDtoFactory
{
    /// <summary>
    ...
    /// </returns>
    Task<SitemapDto> PrepareSitemapDtoAsync(SitemapPageDto pageModel);
    ...
    /// </returns>
    Task<SitemapXmlDto> PrepareSitemapXmlDtoAsync(int id = 0);
    ...
    /// </returns>
    Task<SitemapUrlDto> PrepareLocalizedSitemapUrlAsync(string routeName,
