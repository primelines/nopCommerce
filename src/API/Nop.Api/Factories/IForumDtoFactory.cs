...
/// </summary>
public partial interface IForumDtoFactory
{
    /// <summary>
    ...
    /// </returns>
    Task<ForumGroupDto> PrepareForumGroupDtoAsync(ForumGroup forumGroup);
    ...
    /// </returns>
    Task<BoardsIndexDto> PrepareBoardsIndexDtoAsync();
    ...
    /// </returns>
    Task<ActiveDiscussionsDto> PrepareActiveDiscussionsDtoAsync();
    ...
    /// The task result contains the active discussions model
    /// </returns>
    Task<ActiveDiscussionsDto> PrepareActiveDiscussionsDtoAsync(int forumId, int page);
    ...
    /// </returns>
    Task<ForumPageDto> PrepareForumPageDtoAsync(Forum forum, int page);
    ...
    /// </returns>
    Task<ForumTopicPageDto> PrepareForumTopicPageDtoAsync(ForumTopic forumTopic, int page);
    ...
    /// </returns>
    Task<TopicMoveDto> PrepareTopicMoveAsync(ForumTopic forumTopic);
    ...
    Task PrepareTopicCreateModelAsync(Forum forum, EditForumTopicDto model);
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task PrepareTopicEditModelAsync(ForumTopic forumTopic, EditForumTopicDto model,
    ...
    /// </returns>
    Task<EditForumPostDto> PreparePostCreateModelAsync(ForumTopic forumTopic, int? quote,
        bool excludeProperties);
    ...
    /// The task result contains the edit forum post model
    /// </returns>
    Task<EditForumPostDto> PreparePostEditModelAsync(ForumPost forumPost, bool excludeProperties);
    ...
    /// </returns>
    Task<BoardsSearchDto> PrepareSearchDtoAsync(string searchterms, bool? advs, string forumId,
    ...
    /// </returns>
    Task<LastPostDto> PrepareLastPostDtoAsync(ForumPost forumPost, bool showTopic);
    ...
    /// </returns>
    Task<ForumBreadcrumbDto> PrepareForumBreadcrumbDtoAsync(int? forumGroupId, int? forumId,
        int? forumTopicId);
    ...
    /// </returns>
    Task<CustomerForumSubscriptionsDto> PrepareCustomerForumSubscriptionsDtoAsync(int? page);
    ...
    /// </returns>
    Task<ForumTopicRowDto> PrepareForumTopicRowDtoAsync(ForumTopic topic);
    ...
    /// </returns>
    Task<ForumRowDto> PrepareForumRowDtoAsync(Forum forum);
}