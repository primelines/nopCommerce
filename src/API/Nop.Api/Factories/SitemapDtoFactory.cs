...
/// </summary>
public partial class SitemapDtoFactory : ISitemapDtoFactory
{
    #region Fields
    ...
    public SitemapDtoFactory(BlogSettings blogSettings,
    ...
    /// </returns>
    protected virtual async Task<IList<SitemapUrlDto>> GenerateUrlsAsync()
    {
    ...
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetNewsItemUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetCategoryUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetManufacturerUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetProductUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetProductTagUrlsAsync()
    {
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetTopicUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    protected virtual async Task<SitemapUrlDto> PrepareLocalizedBlogPostUrlModelAsync(BlogPost post, UpdateFrequency updateFreq = UpdateFrequency.Weekly)
    {
        ...
        if (!_localizationSettings.SeoFriendlyUrlsForLanguagesEnabled)
            return new SitemapUrlDto(url, new List<string>(), updateFreq, updatedOn);
    ...
    /// The task result contains the sitemap URLs
    /// </returns>
    protected virtual async Task<IEnumerable<SitemapUrlDto>> GetBlogPostUrlsAsync()
    {
        var store = await _storeContext.GetCurrentStoreAsync();
    ...
    protected virtual IEnumerable<SitemapUrlDto> GetCustomUrls()
    {
        var storeLocation = _webHelper.GetStoreLocation();

        return _sitemapXmlSettings.SitemapCustomUrls.Select(customUrl =>
            new SitemapUrlDto(string.Concat(storeLocation, customUrl), new List<string>(), UpdateFrequency.Weekly, DateTime.UtcNow));
    }
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    protected virtual async Task WriteSitemapAsync(MemoryStream stream, IList<SitemapUrlDto> sitemapUrls)
    {
        await using var writer = XmlWriter.Create(stream, new XmlWriterSettings
        {
            Async = true,
        ...
        foreach (var sitemapUrl in sitemapUrls)
        {
            ...
            {
                await WriteSitemapUrlAsync(writer, new SitemapUrlDto(alternate, sitemapUrl));
            }
        }
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    protected virtual async Task WriteSitemapUrlAsync(XmlWriter writer, SitemapUrlDto sitemapUrl)
    {
    ...
    /// </returns>
    public virtual async Task<SitemapDto> PrepareSitemapDtoAsync(SitemapPageDto pageModel)
    {
        ...
        var store = await _storeContext.GetCurrentStoreAsync();
        var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(NopDtoCacheDefaults.SitemapPageDtoKey,
        ...
        var cachedModel = await _staticCacheManager.GetAsync(cacheKey, async () =>
        {
            ...
            if (_sitemapSettings.SitemapIncludeTopics)
            {
                ...
                model.Items.AddRange(await topics.SelectAwait(async topic => new SitemapDto.SitemapItemModel
                {
                    GroupTitle = commonGroupTitle,
            ...
            if (_sitemapSettings.SitemapIncludeBlogPosts && _blogSettings.Enabled)
            {
                ...
                model.Items.AddRange(await blogPosts.SelectAwait(async post => new SitemapDto.SitemapItemModel
                {
            ...
            if (_sitemapSettings.SitemapIncludeNews && _newsSettings.Enabled)
            {
                ...
                model.Items.AddRange(await news.SelectAwait(async newsItem => new SitemapDto.SitemapItemModel
                {
            ...
            if (_sitemapSettings.SitemapIncludeCategories)
            {
                ...
                model.Items.AddRange(await categories.SelectAwait(async category => new SitemapDto.SitemapItemModel
                {
            ...
            if (_sitemapSettings.SitemapIncludeManufacturers)
            {
                ...
                model.Items.AddRange(await manufacturers.SelectAwait(async manufacturer => new SitemapDto.SitemapItemModel
                {
            ...
            if (_sitemapSettings.SitemapIncludeProductTags)
            {
                ...
                model.Items.AddRange(await productTags.SelectAwait(async productTag => new SitemapDto.SitemapItemModel
                {
        ...
        var pagedItems = new PagedList<SitemapDto.SitemapItemModel>(cachedModel.Items, pageModel.PageNumber - 1, pageModel.PageSize);
        var sitemapModel = new SitemapDto { Items = pagedItems };
        sitemapModel.Page.LoadPagedList(pagedItems);
    ...
    /// </returns>
    public virtual async Task<SitemapXmlDto> PrepareSitemapXmlDtoAsync(int id = 0)
    {
        var language = await _workContext.GetWorkingLanguageAsync();
        var store = await _storeContext.GetCurrentStoreAsync();
        ...
        {
            return new SitemapXmlDto { SitemapXmlPath = fullPath };
        }
    ...
    /// <param name="updateFreq">How often to update url</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task<SitemapUrlDto> PrepareLocalizedSitemapUrlAsync(string routeName,
        ...
        UpdateFrequency updateFreq = UpdateFrequency.Weekly)
    {
        ...
        return new SitemapUrlDto(url, localizedUrls, updateFreq, updatedOn);
    }
