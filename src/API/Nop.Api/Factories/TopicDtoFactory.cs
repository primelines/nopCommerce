...
/// </summary>
public partial class TopicDtoFactory : ITopicDtoFactory
{
    #region Fields
    ...
    public TopicDtoFactory(ILocalizationService localizationService,
    ...
    /// </returns>
    public virtual async Task<TopicDto> PrepareTopicDtoAsync(Topic topic)
    {
    ...
    /// The task result contains the topic model
    /// </returns>
    public virtual async Task<TopicDto> PrepareTopicDtoBySystemNameAsync(string systemName)
    {
        //load by store
        ...
        return await PrepareTopicDtoAsync(topic);
    }
