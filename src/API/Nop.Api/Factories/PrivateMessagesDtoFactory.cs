...
/// </summary>
public partial class PrivateMessagesDtoFactory : IPrivateMessagesDtoFactory
{
    #region Fields
    ...
    public PrivateMessagesDtoFactory(CustomerSettings customerSettings,
    ...
    /// </returns>
    public virtual Task<PrivateMessageIndexDto> PreparePrivateMessageIndexDtoAsync(int? page, string tab)
    {
        var inboxPage = 0;
        var sentItemsPage = 0;
        ...
        var model = new PrivateMessageIndexDto
        {
            InboxPage = inboxPage,
    ...
    /// </returns>
    public virtual async Task<PrivateMessageListDto> PrepareInboxModelAsync(int page, string tab)
    {
        if (page > 0)
        {
            page -= 1;
        ...
        var messages = new List<PrivateMessageDto>();
        ...
        foreach (var pm in list)
            messages.Add(await PreparePrivateMessageDtoAsync(pm));
        ...
        var model = new PrivateMessageListDto
        {
            Messages = messages,
            Pager = pagerModel
        };
    ...
    /// The task result contains the private message list model
    /// </returns>
    public virtual async Task<PrivateMessageListDto> PrepareSentModelAsync(int page, string tab)
    {
        if (page > 0)
        {
            page -= 1;
    ...
    /// </returns>
    public virtual async Task<SendPrivateMessageDto> PrepareSendPrivateMessageDtoAsync(Customer customerTo, PrivateMessage replyToPM)
    {
        ArgumentNullException.ThrowIfNull(customerTo);

        var model = new SendPrivateMessageDto
        {
    ...
    /// </returns>
    public virtual async Task<PrivateMessageDto> PreparePrivateMessageDtoAsync(PrivateMessage pm)
    {
        ...
        var model = new PrivateMessageDto
        {
            Id = pm.Id,
