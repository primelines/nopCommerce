...
/// </summary>
public partial class ProfileDtoFactory : IProfileDtoFactory
{
    #region Fields
    ...
    public ProfileDtoFactory(CustomerSettings customerSettings,
    ...
    /// </returns>
    public virtual async Task<ProfileIndexDto> PrepareProfileIndexDtoAsync(Customer customer, int? page)
    {
    ...
    /// </returns>
    public virtual async Task<ProfileInfoDto> PrepareProfileInfoDtoAsync(Customer customer)
    {
        ArgumentNullException.ThrowIfNull(customer);
    ...
    /// </returns>
    public virtual async Task<ProfilePostsDto> PrepareProfilePostsDtoAsync(Customer customer, int page)
    {
        ArgumentNullException.ThrowIfNull(customer);
        ...
        var latestPosts = new List<PostsDto>();
