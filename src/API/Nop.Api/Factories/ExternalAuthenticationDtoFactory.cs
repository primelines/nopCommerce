...
/// </summary>
public partial class ExternalAuthenticationDtoFactory : IExternalAuthenticationDtoFactory
{
    #region Fields
    ...
    public ExternalAuthenticationDtoFactory(IAuthenticationPluginManager authenticationPluginManager,
    ...
    /// </returns>
    public virtual async Task<List<ExternalAuthenticationMethodDto>> PrepareExternalMethodsModelAsync()
    {
        ...
        return (await _authenticationPluginManager
            ...
            .Select(authenticationMethod => new ExternalAuthenticationMethodDto
            {
