...
/// </summary>
public partial class AddressDtoFactory : IAddressDtoFactory
{
    #region Fields
    ...
    public AddressDtoFactory(AddressSettings addressSettings,
    ...
    protected virtual async Task PrepareCustomAddressAttributesAsync(AddressDto model,
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public virtual async Task PrepareAddressDtoAsync(AddressDto model,
