...
/// </summary>
public partial interface IJsonLdDtoFactory
{
    /// <summary>
    ...
    /// </returns>
    Task<JsonLdBreadcrumbListDto> PrepareJsonLdCategoryBreadcrumbAsync(IList<CategorySimpleDto> categoryModels);
    ...
    /// </returns>
    Task<JsonLdBreadcrumbListDto> PrepareJsonLdProductBreadcrumbAsync(ProductBreadcrumbDto breadcrumbModel);
    ...
    /// </returns>
    Task<JsonLdProductDto> PrepareJsonLdProductAsync(ProductDetailsDto model, string productUrl = null);
}