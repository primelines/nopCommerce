...
/// </summary>
public partial class VendorDtoFactory : IVendorDtoFactory
{
    #region Fields
    ...
    public VendorDtoFactory(CaptchaSettings captchaSettings,
    ...
    /// </returns>
    protected virtual async Task<IList<VendorAttributeDto>> PrepareVendorAttributesAsync(string vendorAttributesXml)
    {
        var result = new List<VendorAttributeDto>();

        var vendorAttributes = await _vendorAttributeService.GetAllAttributesAsync();
        foreach (var attribute in vendorAttributes)
        {
            var attributeModel = new VendorAttributeDto
            {
                Id = attribute.Id,
            ...
            if (attribute.ShouldHaveValues)
            {
                ...
                {
                    var valueModel = new VendorAttributeValueDto
                    {
    ...
    /// </returns>
    public virtual async Task<ApplyVendorDto> PrepareApplyVendorDtoAsync(ApplyVendorDto model,
    ...
    /// </returns>
    public virtual async Task<VendorInfoDto> PrepareVendorInfoDtoAsync(VendorInfoDto model,
