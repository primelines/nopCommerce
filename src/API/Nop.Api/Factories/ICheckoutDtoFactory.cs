...
public partial interface ICheckoutDtoFactory
{
    /// <summary>
    ...
    /// </returns>
    Task<CheckoutBillingAddressDto> PrepareBillingAddressDtoAsync(IList<ShoppingCartItem> cart,
    ...
    /// </returns>
    Task<CheckoutShippingAddressDto> PrepareShippingAddressDtoAsync(IList<ShoppingCartItem> cart, int? selectedCountryId = null,
    ...
    /// </returns>
    Task<CheckoutShippingMethodDto> PrepareShippingMethodDtoAsync(IList<ShoppingCartItem> cart, Address shippingAddress);
    ...
    /// </returns>
    Task<CheckoutPaymentMethodDto> PreparePaymentMethodDtoAsync(IList<ShoppingCartItem> cart, int filterByCountryId);
    ...
    /// </returns>
    Task<CheckoutPaymentInfoDto> PreparePaymentInfoModelAsync(IPaymentMethod paymentMethod);
    ...
    /// </returns>
    Task<CheckoutConfirmDto> PrepareConfirmOrderDtoAsync(IList<ShoppingCartItem> cart);
    ...
    /// </returns>
    Task<CheckoutCompletedDto> PrepareCheckoutCompletedDtoAsync(Order order);
    ...
    /// </returns>
    Task<CheckoutProgressDto> PrepareCheckoutProgressDtoAsync(CheckoutProgressStep step);
    ...
    /// </returns>
    Task<OnePageCheckoutDto> PrepareOnePageCheckoutDtoAsync(IList<ShoppingCartItem> cart);
}