...
/// </summary>
public partial class InvariantNumberDtoBinderProvider : IModelBinderProvider
{
    #region Fields
    ...
    public IModelBinder GetBinder(ModelBinderProviderContext context)
    {
        ...
        if (_floatingPointTypes.Contains(modelType))
            return new InvariantNumberDtoBinder(NumberStyles.Float, new FloatingPointTypeModelBinderProvider().GetBinder(context));

        if (_integerTypes.Contains(modelType))
            return new InvariantNumberDtoBinder(NumberStyles.Integer, new SimpleTypeModelBinderProvider().GetBinder(context));
