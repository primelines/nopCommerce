...
namespace Nop.Api.Framework.Dtos.Extensions;
...
public static class DtoExtensions
{
    ...
    public static IPagedList<T> ToPagedList<T>(this IList<T> list, IPagingRequestDto pagingRequestModel)
    {
    ...
    /// </returns>
    public static async Task<IPagedList<T>> ToPagedListAsync<T>(this IAsyncEnumerable<T> collection, IPagingRequestDto pagingRequestModel)
    {
    ...
    public static TListModel PrepareToGrid<TListModel, TModel, TObject>(this TListModel listModel,
        BaseSearchDto searchModel, IPagedList<TObject> objectList, Func<IEnumerable<TModel>> dataFillFunction)
        where TListModel : BasePagedListDto<TModel>
        where TModel : BaseNopDto
    {
    ...
    public static async Task<TListModel> PrepareToGridAsync<TListModel, TModel, TObject>(this TListModel listModel,
        BaseSearchDto searchModel, IPagedList<TObject> objectList, Func<IAsyncEnumerable<TModel>> dataFillFunction)
        where TListModel : BasePagedListDto<TModel>
        where TModel : BaseNopDto
    {
        ArgumentNullException.ThrowIfNull(listModel);
