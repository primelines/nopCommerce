...
public abstract partial class BaseController : ControllerBase
{
    ...
    protected IActionResult Error()
    {
        ...
        return Problem(detail: errors.ToString(), statusCode: 422);
    }


    protected IActionResult Error( string propertyKey = "", string errorMessage = "")
    {
        var errors = new Dictionary<string, List<string>>();
    ...
    {
        return Forbid(); //new StatusCodeResult(Microsoft.AspNetCore.Http.StatusCodes.Status403Forbidden);
    }
    ...
    //            break;
    //        }
    //        case IEnumerable<BaseNopDto> modelCollection:
    //        {
    //            var eventPublisher = EngineContext.Current.Resolve<IEventPublisher>();
    ...
    protected virtual async Task AddLocalesAsync<TLocalizedModelLocal>(ILanguageService languageService,
        IList<TLocalizedModelLocal> locales) where TLocalizedModelLocal : ILocalizedLocaleDto
    {
    ...
    protected virtual async Task AddLocalesAsync<TLocalizedModelLocal>(ILanguageService languageService,
        IList<TLocalizedModelLocal> locales, Action<TLocalizedModelLocal, int> configure) where TLocalizedModelLocal : ILocalizedLocaleDto
    {
    ...
    //    return Error(await localizationService.GetResourceAsync("Admin.AccessDenied.Description"));
    //}
    ...
    //    //"GetSelectedCardName" method of \Nop.Api.Framework\Extensions\HtmlExtensions.cs
    ...
    //{
    //    //keep this method synchronized with
    //    //"GetSelectedTabName" method of \Nop.Api.Framework\Extensions\HtmlExtensions.cs
