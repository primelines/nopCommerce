...
public partial class NopStartup : INopStartup
{
    ...
    public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        //store context
        services.AddScoped<IStoreContext, ApiStoreContext>();
        ...
        //services.AddScoped<IVideoLikeService, VideoLikeService>();
        //services.AddScoped<IVideoModerationService, VideoModerationService>();
        //services.AddScoped<IVideoOrderAttributionService, VideoOrderAttributionService>();
        //services.AddScoped<IVideoPlaylistService, VideoPlaylistService>();
        //services.AddScoped<IVideoProductMomentService, VideoProductMomentService>();
        //services.AddScoped<IVideoReportService, VideoReportService>();
        services.AddScoped<IVideoService, VideoService>();
        //services.AddScoped<IVideoSoundService, VideoSoundService>();
        //services.AddScoped<IVideoStatsService, VideoStatsService>();
        //services.AddScoped<IVideoTagService, VideoTagService>();
        //services.AddScoped<IVideoTranscodeService, VideoTranscodeService>();
        //services.AddScoped<IVideoViewService, VideoViewService>();


        
        //services.AddScoped<IVendorFollowService, VendorFollowService>();
