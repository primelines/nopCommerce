...
/// </summary>
public partial class StoreMappingSupportedDtoFactory : IStoreMappingSupportedDtoFactory
{
    #region Fields
    ...
    public StoreMappingSupportedDtoFactory(IStoreMappingService storeMappingService,
    ...
    public virtual async Task PrepareModelStoresAsync<TModel>(TModel model) where TModel : IStoreMappingSupportedDto
    {
    ...
    public virtual async Task PrepareModelStoresAsync<TModel, TEntity>(TModel model, TEntity entity, bool ignoreStoreMappings)
        where TModel : IStoreMappingSupportedDto where TEntity : BaseEntity, IStoreMappingSupported
    {
        ArgumentNullException.ThrowIfNull(model);
