...
/// </summary>
public partial class AclSupportedDtoFactory : IAclSupportedDtoFactory
{
    #region Fields
    ...
    public AclSupportedDtoFactory(IAclService aclService,
    ...
    public virtual async Task PrepareModelCustomerRolesAsync<TModel>(TModel model) where TModel : IAclSupportedDto
    {
        ...
        where TModel : IAclSupportedDto where TEntity : BaseEntity, IAclSupported
    {
        ...
        if (!ignoreAclMappings && entity != null)
            model.SelectedCustomerRoleIds = (await _aclService.GetCustomerRoleIdsWithAccessAsync(entity.Id,nameof(entity))).ToList();
