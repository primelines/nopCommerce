...
/// </summary>
public partial class LocalizedDtoFactory : ILocalizedDtoFactory
{
    #region Fields
    ...
    public LocalizedDtoFactory(ILanguageService languageService)
    {
    ...
    /// </returns>
    public virtual async Task<IList<T>> PrepareLocalizedModelsAsync<T>(Func<T, int, Task> configure = null) where T : ILocalizedLocaleDto
    {
